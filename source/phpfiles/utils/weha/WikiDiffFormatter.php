...
class WikiDiffFormatter {
	...
	public function outputDiff()
	{
		...
		$this->output .= ("<br/>");
		$this->output .= "Number of sentence deletes : ".$sentenceDeletesCount."";
		$this->output .= ("<br/>");
		$this->output .= "Number of edit deletes : ".$deletesCount."";
		$this->output .= ("<br/>");
		$this->output .= "Number of moves : ".$movesCount."";
		$this->output .= ("<br/>");
		$this->output .= "Number of moves 2 : ".$movesCount2."";
		$this->output .= ("<br/>");
		$this->output .= "Number of sentence inserts : ".$sentenceInsertsCount."";
		$this->output .= ("<br/>");
		$this->output .= "Number of inserts : ".$insertsCount."";
		$this->output .= ("<br/>");
