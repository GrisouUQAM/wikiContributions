...
Notre code est divisé en 2 dossiers: un contenant le code fourni par **Google-Diff, Match and Patch** pour faire la comparaison de différentes révisions (que vous trouverez dans le dossier `google-diff`) et un autre utilisant **WEHA** pour faire ces comparaisons (dans le dossier `weha`).
